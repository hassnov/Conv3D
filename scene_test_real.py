    ...
    for s in range(0, scenes_count):
        ...
        for model_num in range(len(model_paths)):
            ...
            with tf.Graph().as_default() as graph:
                ...
                logits, regularizers, conv1, pool1, h_fc0, h_fc1 = convnnutils.build_graph_3d_5_5_3_3_3(net_x, 0.5, 7267, train=False)
                ...
                with open("results_real.txt", "a") as myfile:
                    ...
                    myfile.close()
                with open("precision_real.txt", "a") as myfile:
                    myfile.write("{0:.4f}".format(correct) + '\n')
                    myfile.close()
                with open("recall_real.txt", "a") as myfile:
