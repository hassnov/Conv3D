...
def main(args):
    ...
    for s in range(0, scenes_count):
        ...
        for model_num in range(len(model_paths)):
            ...
            num_cf_b4, _, _ = utils.num_corresponding_features(reader.samples, reader_scene.samples, reader_scene.data, trans_mat, support_radii/1.9)
            print "num_corresponding_features before same: ", num_cf_b4
            ...
            reader_scene.sample_indices = get_indices(reader_scene.data, reader_scene.samples)
            num_cf, _, _ = utils.num_corresponding_features(reader.samples, reader_scene.samples, reader_scene.data, trans_mat, support_radii/1.9)
